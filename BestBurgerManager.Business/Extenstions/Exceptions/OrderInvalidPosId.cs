...
namespace BestBurgerManager.Business.Extenstions.Exceptions
{
    ...
    /// </summary>
    [Serializable]
    public class OrderInvalidPosIdException : Exception
    {
        /// <summary>
        /// Constructor for this custom exception.
        /// </summary>
        public OrderInvalidPosIdException()
            : base()
        { }
        ...
        public OrderInvalidPosIdException(String message)
          : base(message)
        {
        }
        ...
        public OrderInvalidPosIdException(String message, Exception innerException)
        ...
        protected OrderInvalidPosIdException(SerializationInfo info, StreamingContext context)
          : base(info, context)
        {
        }
    }
