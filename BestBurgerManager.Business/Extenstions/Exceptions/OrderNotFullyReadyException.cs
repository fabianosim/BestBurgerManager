...
namespace BestBurgerManager.Business.Extenstions.Exceptions
{
    ...
    /// </summary>
    [Serializable]
    public class OrderNotFullyReadyException : Exception
    {
        /// <summary>
        /// Constructor for this custom exception.
        /// </summary>
        public OrderNotFullyReadyException()
            : base()
        { }
        ...
        public OrderNotFullyReadyException(String message)
          : base(message)
        {
        }
        ...
        public OrderNotFullyReadyException(String message, Exception innerException)
        ...
        protected OrderNotFullyReadyException(SerializationInfo info, StreamingContext context)
          : base(info, context)
        {
        }
    }
